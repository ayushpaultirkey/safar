SET @place_state = "Madhya Pradesh";
...
SET @place_position = "23.1320,79.8010";
SET @place_image = "/upload/image/BHEDAGHAT.jpg";
...
SET @place_position = "22.467446,78.434585";
SET @place_image = "/upload/image/PACHMARHI.jpg";
...
#############################################################################
SET @place_name = "Gwalior";
SET @place_detail = "Gwalior is a historic city located in the state of Madhya Pradesh. Popular because of the hilltop fort, Gwalior is full of palaces and glorious temples giving this city a majestic charm which speaks volumes of its glorious past.
...
SET @place_position = "26.218287,78.182831";
SET @place_image = "/upload/image/GWALIOR.jpg";
...
#############################################################################
SET @place_name = "Kanha National Park";
SET @place_detail = "Located in a central region of Madhya Pradesh, Kanha National Park is the largest National Park in central India and has been ranked as one of the best parks in Asia. Among the 22 species of large mammals, the royal Bengal tigers are one of the major attractions. One of the best tiger reserves in India, the present-day area stretches over the 940-kilometre square which is divided into two sanctuaries: Hallon and Banjar. 
...
SET @place_position = "22.2830554,80.6181028";
SET @place_image = "/upload/image/KANHA-NATIONAL-PARK.jpg";
